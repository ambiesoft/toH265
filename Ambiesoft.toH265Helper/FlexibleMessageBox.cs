    ...
    public class FlexibleMessageBox
    {
        ...
        class FlexibleMessageBoxForm : Form
        {
            ...
            private void InitializeComponent()
            {
                ...
                this.Load += new System.EventHandler(this.FlexibleMessageBoxForm_OnLoad);
            ...
            {
                flexibleMessageBoxForm.icon_ = icon;
                switch (icon)
                {
            ...
            private void FlexibleMessageBoxForm_OnLoad(object sender, EventArgs e)
            {
                switch(this.icon_)
                {
