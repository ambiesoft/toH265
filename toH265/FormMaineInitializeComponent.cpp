...
namespace Ambiesoft {
	namespace toH265 {
		...
		void FormMain::InitializeComponent(void)
		{
            ...
            this->tsmiCPUAffinity->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(4) {
                this->tsmiCPUAffinityEnable,
                    this->tsmsCpuAffinityBegin, this->tsmsCpuAffinityEnd, this->tsmiClearAllButZero
            });
