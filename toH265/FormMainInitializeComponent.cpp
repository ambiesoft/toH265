...
namespace Ambiesoft {
	namespace toH265 {
		...
		void FormMain::InitializeComponent(void)
		{
            ...
            this->tsmiEnableHalfUpper = (gcnew System::Windows::Forms::ToolStripMenuItem());
            this->tsmiEnableHalfEven = (gcnew System::Windows::Forms::ToolStripMenuItem());
            ...
            // tsmiCPUAffinity
            // 
            this->tsmiCPUAffinity->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(8) {
                this->tsmiCPUAffinityEnable,
                    this->tsmsCpuAffinityBegin, this->tsmsCpuAffinityEnd, this->tsmiEnableAll, this->tsmiToggleAll, this->tsmiEnableHalfUpper, this->tsmiEnableHalfEven,
                    this->tsmiClearAllButZero
            });
            ...
            // tsmiEnableHalfUpper
            // 
            this->tsmiEnableHalfUpper->Name = L"tsmiEnableHalfUpper";
            resources->ApplyResources(this->tsmiEnableHalfUpper, L"tsmiEnableHalfUpper");
            this->tsmiEnableHalfUpper->Click += gcnew System::EventHandler(this, &FormMain::tsmiEnableHalfUpper_Click);
            // 
            // tsmiEnableHalfEven
            // 
            this->tsmiEnableHalfEven->Name = L"tsmiEnableHalfEven";
            resources->ApplyResources(this->tsmiEnableHalfEven, L"tsmiEnableHalfEven");
            this->tsmiEnableHalfEven->Click += gcnew System::EventHandler(this, &FormMain::tsmiEnableHalfEven_Click);
            // 
            // tsmiClearAllButZero
            // 
